    ...
    with open(assembly.chains_fname) as f:
        ...
        for line in f:
            ...
            if "Aln" in line and len(fs) >= 8:
                ...
                read_alignments[read_name[1:]].append((ref_start, ref_end, align_start, align_end, seq_div))
            elif len(fs) >= 2:
                ...
                read_seeds[read_name[1:]][(ref_start, ref_end, align_start, align_end, seq_div)].append((read_pos, ref_pos))
                ...
                if len(seeds) >= MIN_CHAIN_KMERS:
                    ...
                    if assembly.real_coords:
                        for i,s in enumerate(seeds):
                            seeds[i] = (reads_real_coords[read_name][s[0]], assembly.real_coords[assembly_id][s[1]])
